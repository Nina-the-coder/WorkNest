            ...
            >
              ...
              <div className="flex flex-col justify-between w-1/2">
                <div className="text-white flex">
                  <div>{quotation.quotationId} - {quotation.customerId?.customerId}</div>
                  <div className={`ml-30 text-black py-0.5 px-4 rounded-xl ${quotation.status === "pending" ? "bg-amber-500": quotation.status === "approved" ? "bg-emerald-500": "bg-rose-500"}`}>{quotation.status}</div> 
                </div>
              ...
              <div className="flex flex-col justify-between">
                <button className="p-1 w-20 bg-indigo-800 hover:bg-indigo-900 text-white hover:cursor-pointer">
                  Approve
                </button>
                <button className="p-1 w-20 bg-indigo-800 hover:bg-indigo-900 text-white hover:cursor-pointer">
                  Reject
              ...
              <div className="flex justify-center">
                <button className="h-full w-20 bg-slate-700 cursor-pointer hover:bg-slate-600">
                  Make Order
                </button>
              </div>
            </div>
