...
import EmployeeTaskManagement from "../../modules/task/pages/EmployeeTaskManagement";
import EmployeeQuotationManagement from "../quotation/pages/EmployeeQuotationManagement";
import EmployeeOrderManagement from "../order/pages/EmployeeOrderManagement";
  ...
  return (
    <div>
      ...
      <div className="flex flex-wrap justify-evenly bg-slate-900 min-h-screen">
        ...
        {/* quotations */}
        {!customerModal && <EmployeeQuotationManagement />}

        {/* orders */}
        {!customerModal && <EmployeeOrderManagement />}
